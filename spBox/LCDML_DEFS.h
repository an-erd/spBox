...
LCDML_DISP_add(11, _LCDML_G1, LCDML_root_2, 2, "MQTT", LCDML_FUNC);
...
LCDML_DISP_add(16, _LCDML_G1, LCDML_root_3_2, 1, "Accel", LCDML_FUNC);
LCDML_DISP_add(17, _LCDML_G1, LCDML_root_3_2, 2, "Gyro", LCDML_FUNC);
LCDML_DISP_add(18, _LCDML_G1, LCDML_root_3_2, 3, "Kompass", LCDML_FUNC);
...
LCDML_DISP_add(30, _LCDML_G1, LCDML_root_4, 2, "Besitzer", LCDML_FUNC_ownerinformation);
LCDML_DISP_add(31, _LCDML_G1, LCDML_root_4, 3, "QR-Code", LCDML_FUNC_test2);
...
LCDML_DISP_add(38, _LCDML_G7, LCDML_root, 6, "Initscreen", LCDML_FUNC_initscreen); // in g7 => hidden
