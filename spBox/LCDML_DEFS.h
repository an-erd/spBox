...
LCDML_DISP_add(21, _LCDML_G1, LCDML_root_3, 3, "MQTT", LCDML_FUNC);
LCDML_DISP_add(22, _LCDML_G1, LCDML_root_3_3, 1, "Einstellungen", LCDML_FUNC_config_mqtt);
LCDML_DISP_add(23, _LCDML_G1, LCDML_root_3_3, 2, "Broker ausw\204hlen", LCDML_FUNC_select_mqtt);
LCDML_DISP_add(24, _LCDML_G1, LCDML_root_3_3, 3, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(25, _LCDML_G1, LCDML_root_3, 4, "Werkseinstellung", LCDML_FUNC);
LCDML_DISP_add(26, _LCDML_G1, LCDML_root_3_4, 1, "Ger\204t zur\201cksetzen", LCDML_FUNC);
LCDML_DISP_add(27, _LCDML_G1, LCDML_root_3_4_1, 1, "Jetzt zur\201cksetzen", LCDML_FUNC_reset);
LCDML_DISP_add(28, _LCDML_G1, LCDML_root_3_4_1, 2, "Abbruch", LCDML_FUNC_back);
LCDML_DISP_add(29, _LCDML_G1, LCDML_root_3_4, 2, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(30, _LCDML_G1, LCDML_root_3, 5, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(31, _LCDML_G1, LCDML_root, 4, "Information", LCDML_FUNC);
LCDML_DISP_add(32, _LCDML_G1, LCDML_root_4, 1, "Zeit", LCDML_FUNC_clock);
LCDML_DISP_add(33, _LCDML_G1, LCDML_root_4, 2, "Besitzer", LCDML_FUNC_ownerinformation);
LCDML_DISP_add(34, _LCDML_G1, LCDML_root_4, 3, "Sensor-Ausrichtung", LCDML_FUNC);
LCDML_DISP_add(35, _LCDML_G1, LCDML_root_4_3, 1, "Accel", LCDML_FUNC_scrolltest);
LCDML_DISP_add(36, _LCDML_G1, LCDML_root_4_3, 2, "Gyro", LCDML_FUNC);
LCDML_DISP_add(37, _LCDML_G1, LCDML_root_4_3, 3, "Kompass", LCDML_FUNC);
LCDML_DISP_add(38, _LCDML_G1, LCDML_root_4_3, 4, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(39, _LCDML_G1, LCDML_root_4, 4, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(40, _LCDML_G7, LCDML_root, 5, "Initscreen", LCDML_FUNC_initscreen); // in g7 => hidden
LCDML_DISP_add(41, _LCDML_G2, LCDML_root, 6, "Entsperren", LCDML_FUNC_unlock);
LCDML_DISP_add(42, _LCDML_G1, LCDML_root, 7, "Sperren", LCDML_FUNC_lock);
