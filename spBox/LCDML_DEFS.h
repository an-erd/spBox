...
LCDML_DISP_add(22, _LCDML_G1, LCDML_root_3_3, 1, "Einstellungen", LCDML_FUNC);
#define LCDML_MENU_MQTT_TOGGLE		23
LCDML_DISP_add(23, _LCDML_G1, LCDML_root_3_3_1, 1, "MQTT aktiv:      %s", LCDML_FUNC_toggle_mqtt);
#define LCDML_MENU_MQTT_HEALTHDATA	24
LCDML_DISP_add(24, _LCDML_G1, LCDML_root_3_3_1, 2, "MQTT Healthdata: %s", LCDML_FUNC_toggle_mqtthealth);
LCDML_DISP_add(25, _LCDML_G1, LCDML_root_3_3_1, 3, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(26, _LCDML_G1, LCDML_root_3_3, 2, "Broker ausw\204hlen", LCDML_FUNC_select_mqtt);
LCDML_DISP_add(27, _LCDML_G1, LCDML_root_3_3, 3, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(28, _LCDML_G1, LCDML_root_3, 4, "Werkseinstellung", LCDML_FUNC);
LCDML_DISP_add(29, _LCDML_G1, LCDML_root_3_4, 1, "Ger\204t zur\201cksetzen", LCDML_FUNC);
LCDML_DISP_add(30, _LCDML_G1, LCDML_root_3_4_1, 1, "Jetzt zur\201cksetzen", LCDML_FUNC_reset);
LCDML_DISP_add(31, _LCDML_G1, LCDML_root_3_4_1, 2, "Abbruch", LCDML_FUNC_back);
LCDML_DISP_add(32, _LCDML_G1, LCDML_root_3_4, 2, "Zur\201ck", LCDML_FUNC_back);
LCDML_DISP_add(33, _LCDML_G1, LCDML_root_3, 5, "Zur\201ck", LCDML_FUNC_back);
